package Tugas_LAB_PBO.TP_4.Task1_LoginApp;

import java.util.ArrayList;
import java.util.Scanner;
import Tugas_LAB_PBO.TP_4.Task1_LoginApp.Models.*;
import Tugas_LAB_PBO.TP_4.Task1_LoginApp.Utils.StringUtils;
...
public class Main {
        ...
        try {
            ...
            switch (selectMenu) {
                ...
                default:
                    ...
                    System.out.println("=".repeat(25) + "\nERROR: There's no option " + selectMenu + "\n" + "=".repeat(25));
                    runApp();
                    
            }
        } catch (Exception e) {
            System.out.println("=".repeat(25) + "\nWARNING: The Input is wrong" + "\n" + "=".repeat(25));
            sc.nextLine();
            runApp();
        }
    }
    ...
    private static void showLoginMenu() {
        ...
        }else {System.out.printf("Username Tidak ditemukan");}
    }
