...
public class App extends Application {
    ...
    private void HomeScene() {
        ...
        Text text1 = new Text("Hi, My Name is Wahyu");
        ...
        Text text3 = new Text("My Aplikasi");
    ...
    private void ProfileScene() {
        ...
        Image logoImage = new Image("/wahyu.png");
