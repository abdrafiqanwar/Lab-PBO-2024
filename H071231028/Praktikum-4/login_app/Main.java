...
public class Main {
    ...
    private static void showRegisterMenu() {
        ...
        if (isUsernameTaken) {
            ...
            showRegisterMenu(); // Rekursif untuk kembali ke menu register
        } else {
            String password = " ";
            boolean isValidPassword = false;
    
            while (!isValidPassword) {
                System.out.println("Password (min 8 characters)");
                System.out.print("> ");
                String passwordInput = sc.nextLine();
                if (passwordInput.length() < 8) {
                    System.out.println("Password terlalu pendek. Harap gunakan minimal 8 karakter.");
                } else {
