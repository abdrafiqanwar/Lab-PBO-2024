interface IMove {
    void move(); // methodnya emang tdk memiliki body, dan akan di override di kelas anakannya
}
abstract class Dog implements IMove {
    ...
    abstract void describe(); //untuk mengsi kelas anakan, abstract masi bisa dibuatkan method dengan body
...
public class Main {
    public static void main(String[] args) {
        ...
        System.out.println("=".repeat(50));
        bulldog.describe();
        System.out.println("Pitbull's Average Length  : " + bulldog.averageLenght);
        System.out.println("Pitbull's Position now    : " + bulldog.position);
        bulldog.move();
    }
}
