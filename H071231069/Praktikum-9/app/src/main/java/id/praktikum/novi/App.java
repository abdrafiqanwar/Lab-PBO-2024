...
//     public void switchToProfileScene(String name, String birth, String nim) {
//         ProfileScene profileScene = new ProfileScene(this, name, birth, nim);
...
public class App extends Application {
    ...
    private Scene profileScene(Stage stage) {
        ...
        Image image1 = new Image(getClass().getResource("/pro.jpg").toExternalForm());
        ImageView imageView1 = new ImageView(image1);
        imageView1.setFitWidth(90);
        imageView1.setFitHeight(120);
        imageView1.relocate(90, 150);
        ...
        Pane root = new Pane();
        root.getChildren().addAll(profil, back, imageView1, hasilNama, hasilDate);
        root.getStyleClass().add("latar");
        Scene scene = new Scene(root, 640, 480);
        scene.getStylesheets().add(getClass().getResource("/styles.css").toExternalForm());
        return scene;
